        ...
        for i, row in enumerate(self.keyboard_layout):
            ...
            for j, letter in enumerate(row):
                if(j==3 or j==4 or j==11 or j==12):
                        #---------------Navigate Buttons-------------------
                        self.nav_button = QtWidgets.QFrame(self.keyboard_frame)
                ...
                "border-radius: 20px;")
                        ...
                        if(i==1 and (j==2 or j==13)):
                                ...
                                self.letter.setGeometry(QtCore.QRect(20, 10, 36, 36))#widget.setGeometry(QtCore.QRect(x, y, width, height))
                                #self.letter_a_29.setGeometry(QtCore.QRect(10, 10, 1, 1))
                                if(j==2):
                                        self.letter.setPixmap(QtGui.QPixmap("./images/shoot_right.png"))
                                else:
                                ...
                                self.gridLayout.addWidget(self.alpha_button, i, j, 1, 1)#gridLayout.addWidget(widget, row, column, rowSpan, columnSpan)
                                ...
                                self.letter.setGeometry(QtCore.QRect(10, 10, 31, 31))
                                font = QtGui.QFont()
                                font.setPointSize(24)
                                font.setBold(True)
                                font.setWeight(75)
                        ...
                        self.button_row.append(self.alpha_button)
